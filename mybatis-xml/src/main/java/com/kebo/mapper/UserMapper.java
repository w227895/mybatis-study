...
public interface UserMapper {
	...
	*/
	...
	/*List<SysRole> selectRolesByUserIdAndRoleEnabled(@Param("a")Long userId,
													@Param("b") Integer enabled);*/
	/*List<SysRole> selectRolesByUserIdAndRoleEnabled(@Param("0")Long userId,
													@Param("1") Integer enabled);*/
}
